...
#Create colume called "Best_Picture" and note if the award was nominated, won, or NA
...
bestpic_df['winner'] = bestpic_df['winner'].fillna('missing')

bestpic_df.loc[bestpic_df['category'].str.contains("BEST PICTURE"),'Best_Picture'] = "Nominated"

bestpic_df.loc[bestpic_df['winner']==True,'Best_Picture'] = "Won"
